...
const Header = () => {
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-19 px-4 mt-10 lg:px-44 sm:mt-20'>
        {/*---------------Left Side-----------*/}
        <div className=''>
           ...
           <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br className='max-sm:hidden'/> Vivamus lacinia odio vitae vestibulum vestibulum.</p>
           <div>
